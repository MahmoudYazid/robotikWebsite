                  ...
                  return (
                    ...
                    <div key={Math.random()}  className="w-full border-2 border-black ">
                      ...
                      <div key={Math.random()} className="flex justify-between items-center">
                        ...
                        <Link key={Math.random()} href={`https://${FetchedData.Link}`} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 transition duration-200">Download</Link>
                        </div>
