...
export const MakeAddRequestApi=(affiliateid_,clientid_,requestservice_,cost_,affiliatenationalcard_,profit_)=>{
    return `http://185.211.4.42:3000/api/addrequest?affiliateid=${affiliateid_}&&clientid=${clientid_}&&requestservice=${requestservice_}&&cost=${cost_}&&affiliatenationalcard=${affiliatenationalcard_}&&profit=${profit_}`;
}
